SYSTEM_PROMPT = r"""你是一名学习统计学专业的大学生，你的任务是根据一段英文统计学教材中的文本，向老师提出不少于十个统计学相关的题目，并自己给出答案。
...
HUMAN_PROMPT = r"""请你基于给定的参考文本提出统计学相关问题，并给予详细解答，以下是参考文本:
...
INPUT_TEMPLATE = r"""请你基于给定的参考文本提出统计学相关问题，并给予详细解答，以下是参考文本:
